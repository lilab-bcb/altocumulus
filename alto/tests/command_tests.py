...
class CommandTests(unittest.TestCase):
    ...
    def test_create_sample_sheet_r1_r2(self):
        alto.commands.sample_sheet.main(
            ["-d", "inputs", "-o", "test_sample_sheet.txt", "-f", "r1_r2"]
        )
    ...
    def test_create_sample_sheet_r1_r2_i1(self):
        alto.commands.sample_sheet.main(
            ["-d", "inputs", "-o", "test_sample_sheet.txt", "-f", "r1_r2_i1"]
        )
    ...
    def test_upload_sample_sheet(self):
        alto.commands.sample_sheet.main(["-d", "inputs", "-o", "test_sample_sheet.txt"])
        alto.commands.upload.main(
            ["--dry-run", "-w", "regev-development/test", "test_sample_sheet.txt"]
        )
        os.remove("test_sample_sheet.txt")

    def test_run(self):
        alto.commands.run.main(
            ["-m", "broadgdac/echo", "-i", "test.json", "-w", "regev-development/test"]
        )
